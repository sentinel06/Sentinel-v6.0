 ...
 *  1. A screen-visible board-level preview panel (Sentinel Zen palette)
...
<title>Agent-Sentinel Executive Audit — ${dateStr}</title>
<style>
...
<body>
  ...
  <div class="narrative-section">
    <div class="section-title">Sentinel Analysis & Findings</div>
  ...
  <div class="footer">
    <div class="footer-left">
      <div class="footer-text">Generated by Agent-Sentinel v6.0 · ${s.reportId}</div>
      <div class="footer-text">© 2026 Agent-Sentinel. This report is classified. Unauthorized distribution is prohibited.</div>
        ...
        >
          ...
          >
            ...
            <div className="p-6 space-y-5">
              ...
              >
                <div>
                  <div>Generated by Agent-Sentinel v6.0 · {report.reportId}</div>
                  <div className="opacity-60 mt-0.5">
                    © 2026 Agent-Sentinel. Classified. Unauthorized distribution prohibited.
                  </div>
                </div>
                <div
