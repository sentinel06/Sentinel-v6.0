...
export const getGetAuditLogsQueryKey = (params?: GetAuditLogsParams) => {
  return [`/api/v1/logs`, ...(params ? [params] : [])] as const;
};
...
export const getGetAuditLogQueryKey = (id: string) => {
  return [`/api/v1/logs/${id}`] as const;
};
...
export const getGetTraceQueryKey = (traceId: string) => {
  return [`/api/v1/traces/${traceId}`] as const;
};
...
>(
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getTrace>>> = ({
    signal,
  }) => getTrace(traceId, { signal, ...requestOptions });
 ...
 */
export const getExportComplianceReportUrl = (
  ...
  return stringifiedParams.length > 0
    ? `/api/v1/compliance/export?${stringifiedParams}`
...
export const getExportComplianceReportQueryKey = (
  params?: ExportComplianceReportParams,
) => {
  return [`/api/v1/compliance/export`, ...(params ? [params] : [])] as const;
};

export const getExportComplianceReportQueryOptions = <
  TData = Awaited<ReturnType<typeof exportComplianceReport>>,
  TError = ErrorType<unknown>,
>(
  params: ExportComplianceReportParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof exportComplianceReport>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getExportComplianceReportQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof exportComplianceReport>>
  > = ({ signal }) =>
    exportComplianceReport(params, { signal, ...requestOptions });
...
export type ExportComplianceReportQueryResult = NonNullable<
  Awaited<ReturnType<typeof exportComplianceReport>>
>;
...
export const getGetIntegrityStatusQueryKey = () => {
  return [`/api/v1/integrity/status`] as const;
};
...
export const getVerifyIntegrityMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type VerifyIntegrityMutationResult = NonNullable<
  Awaited<ReturnType<typeof verifyIntegrity>>
>;
