...
- **API Key Self-Service**: Users can view (masked), reveal, copy, and rotate their Sentinel key at any time via `/settings` — no need to return to the onboarding flow.
